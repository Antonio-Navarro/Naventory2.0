...
$(document).ready(function() {
    ...
    if (window.localStorage.collapsedMenu && window.localStorage.collapsedMenu == 'true'){
    	collapsedAction();
    ...
    $('#sidebar-menu').find('a').click(function(ev) {
        var $li = $(this).parent();
    ...
    var elements = $('#sidebar-menu').find('a').filter(function () {
